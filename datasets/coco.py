...
class CocoDetection(TvCocoDetection):
    def __init__(self, img_folder, ann_file, transforms, origin_transforms, return_masks,
    ...
    def __getitem__(self, idx):
        ...
        if self._transforms is not None:
            origin_image, origin_target = self._origin_transform(img, target)
            img, target = self._transforms(img, target)
        return img, target, origin_image, origin_target
